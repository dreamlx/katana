...
ActiveRecord::Schema.define(version: 20160829023153) do
  ...
  add_index "active_admin_comments", ["author_type", "author_id"], name: "id01_author_id"
  add_index "active_admin_comments", ["namespace"], name: "index_active_admin_comments_on_namespace"
  add_index "active_admin_comments", ["resource_type", "resource_id"], name: "id02_resource_id"
